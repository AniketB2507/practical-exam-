...
if type(my_new_list1) is type(my_new_tuple1):
    print('my_new_list1 &  my_new_tuple1 belong to same type')
else:
    print("my_new_list1 &  my_new_tuple1 does not belong to same type")

if type(my_new_tuple1) is type(my_new_tuple2):
    print('my_new_tuple1 & my_new_tuple2 belong to same type')
else:
    print("my_new_tuple1 & my_new_tuple2 does not belong to same type")

if (my_new_list1) is (my_new_list2):
    print("my_new_list1 & my_new_list2 are same")
else:
    print("my_new_list1 & my_new_list2 are not same")